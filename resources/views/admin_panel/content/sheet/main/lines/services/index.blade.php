            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="text-right">
                            <a href="{{ route('content.sheet.main.services.create') }}" type="button" class="btn btn-primary">Добавить услугу</a>
                        </div>
            ...
            @include('admin_panel.layouts.main.alerts')
                <table class="table datatable-column-search-inputs">
                    ...
                    @foreach($services as $service)
                        <tr>
                            <td><a href="{{ route('content.sheet.main.services.edit', $service->get('id')) }}">{{ $service->get('h1') }}</a></td>
                            <td>{{ $service->get('description') }}</td>
                            <td>
                                <form action="{{ route('content.sheet.main.services.destroy', $service->get('id')) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <div class="text-right">
