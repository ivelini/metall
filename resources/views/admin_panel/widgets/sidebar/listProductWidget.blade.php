@foreach($productsName as $prouct)
        @switch($prouct)
                ...
                @case('perehody')
                        ...
                        @break
                @case('troiniki')
                        <li class="nav-item"><a href="{{ route('catalog.products.troiniki.index') }}" class="nav-link">
                                <i class="icon-database-insert"></i> Тройники</a>
                        </li>
                        @break
                @case('dnisha')
                        <li class="nav-item"><a href="{{ route('catalog.products.dnisha.index') }}" class="nav-link">
