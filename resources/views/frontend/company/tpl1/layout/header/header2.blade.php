    ...
    <div class="header-top bg-light sm-text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="widget">
                        <i class="fa fa-clock-o text-theme-colored"></i> Часы работы:  {{ $headerValues->get('workClock') }}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="widget">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
                        ...
                        <h5 class="font-13 text-black m-0"> {{ $headerValues->get('sitePhone') }}</h5>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
            ...
            <div class="container">
                <nav id="menuzord" class="menuzord blue no-bg">
                    ...
                    <div class="pull-right sm-pull-none mb-sm-15">
                        <a class="btn btn-colored btn-flat btn-theme-colored mt-15 mt-sm-10 pt-10 pb-10 ajaxload-popup" href="ajax-load/form-appointment.html">Get a Quote</a>
                    </div>
                </nav>
            </div>
        </div>
