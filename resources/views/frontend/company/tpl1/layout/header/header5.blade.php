                        ...
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="#">Photo Gallery</a>
                                    <ul class="dropdown">
                                        <li><a href="photo-gallery-grid.html">Gallery Grid</a></li>
                                        <li><a href="photo-gallery-masonry-tiles.html">Gallery Masonry Tiles</a></li>
                                    </ul>
                                </li>
                                ...
                                <div class="megamenu-row">
                                    ...
                                    <div class="col4">
                                        ...
                                        <div class="list-dashed">
                                            <article class="post media-post clearfix pb-0 mb-10"> <a href="#" class="post-thumb"><img alt="" src="images/blog/sq1.jpg"></a>
                                                <div class="post-right">
                                                    <h5 class="post-title mt-0"><a href="#">Bankruptcy Rights Proceedings</a></h5>
                                                    <p>Oct 23, 2015</p>
                                                </div>
                                            </article>
                                            <article class="post media-post clearfix pb-0 mb-10"> <a href="#" class="post-thumb"><img alt="" src="images/blog/sq2.jpg"></a>
                                                <div class="post-right">
                                                    <h5 class="post-title mt-0"><a href="#">Assertive and Persistent Advocacy</a></h5>
                                                    <p>Jun 23, 2015</p>
                                                </div>
                                            </article>
                                            <article class="post media-post clearfix pb-0 mb-10"> <a href="#" class="post-thumb"><img alt="" src="images/blog/sq3.jpg"></a>
                                                <div class="post-right">
                                ...
                                <div class="megamenu-row">
                                    ...
                                    <div class="col3">
                                        <ul class="list-unstyled list-dashed">
                                            ...
                                            <li><a href="shortcode-master-sliders.html"><i class="fa fa-sliders"></i> Master Sliders</a></li>
                                    ...
                                    <div class="col3">
                                        <ul class="list-unstyled list-dashed">
                                            ...
                                            <li><a href="shortcode-styled-icons.html"><i class="fa fa-facebook-square"></i> Social Icons</a></li>
