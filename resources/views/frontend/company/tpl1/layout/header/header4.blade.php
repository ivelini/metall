            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
                        <i class="fa fa-envelope text-gray-silver font-32 mt-5 mr-sm-0 sm-display-block pull-left flip sm-pull-none"></i>
                ...
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
                        <i class="fa fa-phone-square text-gray-silver font-32 mt-5 mr-sm-0 sm-display-block pull-left flip sm-pull-none"></i>
                ...
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
                        <i class="fa fa-building-o text-gray-silver font-32 mt-5 mr-sm-0 sm-display-block pull-left flip sm-pull-none"></i>
                ...
                <div class="col-xs-12 col-sm-12 col-md-3">
                    <div class="widget no-border text-right flip sm-text-center mb-10 m-0">
                        <a class="btn btn-colored btn-flat btn-gray mt-15 bs-modal-ajax-load pt-10 pb-10 ajaxload-popup" href="ajax-load/form-appointment.html">Request an appointment</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="menuzord-menu">
                        ...
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="form-login-register-style2.html">Login or Register</a></li>
                                <li><a href="#">About</a>
                                    <ul class="dropdown">
                                ...
                                <li><a href="#home">Expart</a>
                                    <ul class="dropdown">
                                        <li><a href="page-expart-style1.html">Expart style1</a></li>
                                        <li><a href="page-expart-style2.html">Expart style2</a></li>
                                        <li><a href="page-expart-details.html">Expart Details</a></li>
                                    </ul>
                                </li>
                        ...
                        <li><a href="javascript:void(0)">Mega Menu</a>
                            <div class="megamenu megamenu-bg-img">
                                <div class="megamenu-row">
                                    ...
                                    <div class="col3">
                                        <h4 class="megamenu-col-title">Featured News:</strong></h4>
