...
@section('pageheader-title')
    <a href="{{ route('content.sheet.timeline.page.index') }}"><i class="icon-arrow-left52 mr-2"></i></a>Слайдер "{{ $page->h1 }}"
@endsection
@section('header-js')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-right">
                        <a href="{{ route('settings.slider.slide.create', $page->id) }}" type="button" class="btn btn-primary">Добавить слайд</a>
                    </div>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-header header-elements-sm-inline">
                                                        <h6 class="card-title">{{ $slide->h1 }}</h6>
                                                        <div class="header-elements">
                                                            <div class="list-icons ml-3">
                                                                <div class="d-inline-flex">
                                                                    <a href="{{ route('settings.slider.slide.edit', [$page->id, $slide->id]) }}" class="list-icons-item">
                                                                        <i class="icon-cog3"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <div class="card-img-actions mb-3">
                                                                    <img src="@if (!empty($slide->image->img)) {{ $slide->image->img }} @endif" alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
